...
import com.uhamka.bosm.home.repository.te.ElectroFragment
import com.uhamka.bosm.home.repository.ti.InformaticsFragment
import com.uhamka.bosm.home.repository.tm.MachineFragment
...
class RepositoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragmentInformatics = InformaticsFragment()
        val fragmentElectro = ElectroFragment()
        val fragmentMachine = MachineFragment()

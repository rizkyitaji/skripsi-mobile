...
package com.uhamka.bosm.home.repository.te
...
class ElectroFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_electro, container, false)
        ...
        val ref = FirebaseDatabase.getInstance().getReference("Repository")
                .child("Teknik Elektro").orderByChild("judul")
                ...
                build.setMessage("Apakah Anda yakin ingin menghapus skripsi yang berjudul \"" + title + "\" ?")
                        .setPositiveButton("Ya") { _, _ ->
                            ...
                            val skripsi = FirebaseDatabase.getInstance().getReference("Repository")
                                    .child("Teknik Elektro").child(nim)

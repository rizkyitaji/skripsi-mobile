...
package com.uhamka.bosm.home.dashboard.dospem.te
...
class DosenTEFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_dosen_te, container, false)
        ...
        val ref = FirebaseDatabase.getInstance().getReference("Pembimbing")
                .child("Teknik Elektro").orderByChild("name")
            ...
            if (isConnected()) {
                ...
                build.setMessage("Apakah Anda yakin ingin menghapus data dosen pembimbing yang bernama " + name + "?")
                        .setPositiveButton("Ya") { _ , _ ->
                            ...
                            val ref = FirebaseDatabase.getInstance().getReference("Pembimbing")
                                    .child("Teknik Elektro").child(nidn)
    ...
    private fun editData() {
        ...
        val db = FirebaseDatabase.getInstance().getReference("Pembimbing")
                .child("Teknik Elektro").child(id)
        db.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                textProdi.text = getString(R.string.teknik_elektro)
        ...
        submit.setOnClickListener {
            ...
            if (prodi.equals("Choose")) {
                ...
                if (isConnected()) {
                    if (!prodi.equals("Teknik Elektro")){
                        FirebaseDatabase.getInstance().getReference("Pembimbing")
                                .child("Teknik Elektro").child(nidn).removeValue()
                    }
